...
import controllers.users.ViewUserAdminActivate;
...
public class AdminActivate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ViewUserAdminActivate controller = new ViewUserAdminActivate();
            System.out.println("Mpeni sto servlet admin/activet");
